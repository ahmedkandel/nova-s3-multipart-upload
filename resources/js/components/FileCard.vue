<template>
    <card class="flex item-center overflow-hidden p-4">
        ...
        >
            ...
            <a
                v-bind:href="`${this.resourceUrl}/${this.fileId}`"
                v-if="fileId && withMeta.contentDisposition.includes('resource')"
...
export default {
    props: ["fileId", "fileKey", "fileName", "fileSize", "fileMeta", "apiUri", "withMeta", "resourceUrl"],
